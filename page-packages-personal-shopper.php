...
<nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            <!-- Collapse -->
            <?php require_once('template/menu_personal.php'); ?>
        </div>
    </div>
</nav>
<!-- Main content -->
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <?php
                    echo do_shortcode( '[get_packages order="Personal Shopper"]');
                    ?>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <?php
                    echo do_shortcode( '[get_packages_standby order="Personal Shopper"]');
                    ?>
                    <!-- Light table -->
